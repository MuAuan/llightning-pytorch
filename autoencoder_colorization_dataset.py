...
from net_encoder_decoder2D import Encoder, Decoder #, Latent
...
def main():    
    ...
    # show images
    imshow(torchvision.utils.make_grid(images.reshape(32,1,32,32)),'cifar10_initial',text_='original')
    # print labels
    ...
    latent_dim,ver = "Gray2Clolarization", "1"  #####save condition
    dataiter = iter(autoencoder.valloader)
    images, _, labels = dataiter.next()
    # show images
