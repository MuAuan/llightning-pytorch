...
class LitAutoEncoder(pl.LightningModule):
    ...
    def __init__(self, data_dir='./'):
        ...
        self.trans1 = torchvision.transforms.Compose([torchvision.transforms.ToTensor(), torchvision.transforms.Normalize(self.mean, self.std)])
        self.trans2 =  torchvision.transforms.ToTensor() 
...
def main():    
    ...
    summary(autoencoder.decoder,(1024,))
