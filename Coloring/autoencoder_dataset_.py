...
def main():    
    ...
    data_num = 50000
    cifar10_full =ImageDataset(data_num, train=True, transform1=trans4, transform2=trans3)
    ...
    latent_dim,ver = "Gray2ClolarizationNormalizeResize3LYCC", "100"  #####save condition
